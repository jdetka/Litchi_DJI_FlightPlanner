...
# === SETTINGS ===
USE_GSD_MODE = True
KML_PATH = r"C:\Users\jdetk\OneDrive\Desktop\Litchi_DJI_FlightPlanner\AOI\Areawide_Spence-6\Areawide_Spence-6.kml"
OUTPUT_FOLDER = r"C:\Users\jdetk\OneDrive\Desktop\Litchi_DJI_FlightPlanner\mission_output"
OUTPUT_CSV = os.path.join(OUTPUT_FOLDER, "litchi_mission.csv")
OUTPUT_KML = os.path.join(OUTPUT_FOLDER, "photo_preview.kml")
ALTITUDE_INPUT = 60
TARGET_GSD = 0.0275
SPEED = 1.5
FRONTLAP = 0.80
...
for i, line in enumerate(lines):
    ...
    for f in fractions:
        ...
        wp = {
            ...
            "heading(deg)": float(FLIGHT_ANGLE_DEG),
...
batteries_needed = int(np.ceil(flight_time / 20))
