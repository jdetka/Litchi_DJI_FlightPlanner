...
# === SETTINGS ===
USE_GSD_MODE = True
KML_PATH = r"C:\Users\jdetk\Desktop\Litchi_DJI_FlightPlanner\AOI\Otter_LZ_AOI.kml"
OUTPUT_FOLDER = r"C:\Users\jdetk\Desktop\Litchi_DJI_FlightPlanner\mission_output\Otter_LZ"
OUTPUT_CSV = os.path.join(OUTPUT_FOLDER, "Otter_LZ_litchi_mission.csv")
OUTPUT_KML = os.path.join(OUTPUT_FOLDER, "Otter_LZ_MavicPro_photo_preview.kml")
ALTITUDE_INPUT = 20
TARGET_GSD = 0.005
SPEED = 3.5
FRONTLAP = 0.80
...
for i, line in enumerate(lines):
    ...
    for f in fractions:
        ...
        wp = {
            ...
            "photo_distinterval": float(FRONTLAP_SPACING),
            "photo_mode": 1  # <--- THIS ENABLES AUTO CAPTURE
        }
        for j in range(1, 17):
            wp[f"actiontype{j}"] = 0
...
columns = [
    ...
    "poi_altitudemode", "photo_timeinterval", "photo_distinterval", "photo_mode"
]
